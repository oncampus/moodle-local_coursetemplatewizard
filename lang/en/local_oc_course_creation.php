...
$string['settings:template_course_desc'] = 'Set the course area in which the course templates are stored.';
...
$string['form:copy:image_desc'] = 'Please select an image from our collection (left gray button) or upload your own image for your course.';
...
$string['settings:template_textfield_values_desc'] = 'Entering with comma-separated names creates free text input fields in the course input form. As default "last name, course type" two input fields with the name last name and course name are entered.';
...
$string['settings:template_textfield_seperator_desc'] = 'The separators are displayed between each element of the input mask as a drop-down and offer the possibility to make the course name readable.';
$string['settings:template_course_name_readonly'] = 'Read full course name only';
$string['settings:template_course_name_readonly_desc'] =  'Revokes the user\'s editing rights of the form input of the full course name.';
$string['settings:template_course_shortname_readonly'] =  'Short course name read only';
$string['settings:template_course_shortname_readonly_desc'] =  'Revokes the user\'s editing rights of the form input of the short course name.';
...
$string['settings:template_display_seperator_desc'] = 'The separator elements are (not) displayed in the form and replaced by a single space.';