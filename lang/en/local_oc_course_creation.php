...
$string['course_prefix'] = 'Add an prefix to course name';
$string['template_prefix_checkbox_text_desc'] = 'How should the use of the prefix be titled?';
$string['template_prefix_desc'] = 'Set an example course name prefix';
$string['template_prefix_default'] = 'Module 1';
$string['setting_edit_template_prefix'] = 'Course name prefix';
$string['setting_edit_template_checkbox_desc'] = 'Checkbox description';
