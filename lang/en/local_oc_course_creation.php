...
$string['settings:course_prefix'] = 'Add an prefix to course name';
...
$string['oc_course_creation:delete_presets'] = 'Delete course copy presets';
$string['oc_course_creation:edit_presets'] = 'Edit course copy presets';
$string['form:copy:image_desc'] = 'Please select an image from our collection in the "Files" section or upload your own image for your course';
$string['form:copy:image_header'] = 'Select course image';
$string['form:copy:course_name_header'] = 'Enter course name';
$string['form:copy:teacher_name_placeholder'] = 'Lecturer';
