...
$string['form:copy:image_desc'] = 'Wählen Sie bitte ein Bild aus unserer Sammlung im Bereich "Dateien" aus oder laden Sie ein eigenes Bild für Ihren Kurs hoch';
$string['form:copy:image_header'] = 'Kursbild auswählen';
$string['form:copy:course_name_header'] = 'Kursname eingeben';
$string['form:copy:teacher_course_type_placeholder'] = 'Kursname';
$string['form:copy:teacher_name_placeholder'] = 'Dozent*in';
