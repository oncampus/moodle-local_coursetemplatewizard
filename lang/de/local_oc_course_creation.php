...
$string['form:copy:image_desc'] = 'Wählen Sie bitte ein Bild aus unserer Sammlung (linker grauer Button) aus oder laden Sie ein eigenes Bild für Ihren Kurs hoch.';
...
$string['settings:template_textfield_seperator_desc'] = 'Die Trennelemente werden zwischen jedem Element der eingabemaske als Drop-Down angezeigt und bieten die möglichkeit den Kursnamen lesbar zu gestalten.';
$string['settings:template_course_name_readonly'] = 'Vollständiger Kursname nur lesen';
$string['settings:template_course_name_readonly_desc'] = 'Entzieht dem Nutzer die Bearbeitungsrechte der Formulareingabe des vollständigen Kursnamens.';
$string['settings:template_course_shortname_readonly'] = 'Kurzer Kursname nur lesen';
$string['settings:template_course_shortname_readonly_desc'] = 'Entzieht dem Nutzer die Bearbeitungsrechte der Formulareingabe des kurzen Kursnamens.';
...
$string['settings:template_display_seperator_desc'] = 'Die Trennelemente werden (nicht) im Formular angezeigt und durch ein einfaches Leerzeichen ersetzt.';
